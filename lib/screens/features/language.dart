...
import 'package:svara/components/snackbar.dart';
...
const List<String> defaultAppLanguages = ['hindi', 'english'];

final languageNotifierProvider = Provider<ValueNotifier<List<String>>>((ref) {
  final notifier = ValueNotifier<List<String>>(defaultAppLanguages);
...
Future<void> initLanguage(WidgetRef ref) async {
  ...
  ref.read(languageNotifierProvider).value =
      langs.isNotEmpty ? langs : List<String>.from(defaultAppLanguages);
}
