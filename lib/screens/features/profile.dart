              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildBenefitItem("Fast streaming with your custom API"),
                        _buildBenefitItem("Download tracks for offline playback"),
                        _buildBenefitItem("Queue, shuffle, and repeat controls"),
                        _buildBenefitItem("Resume playback across sessions"),
                        _buildBenefitItem("Multi-language search and discovery"),
                      ],
                    ),
                  ),
...
Future<void> loadProfiles() async {
  ...
  username = storedName ?? defaultUsername;
